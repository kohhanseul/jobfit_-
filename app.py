...
규칙:
- 강점은 이력서에 실제 문장으로 있는 것만 인정. 공고에 있는 요건이라도 이력서에 근거 문장이 없으면
  강점에 넣지 말고 부족한 점으로 분류해라. (예: 공고가 SQL을 요구해도 이력서에 SQL이 없으면 강점 아님)
- 공고 요구사항을 기준으로, 아래 세 항목으로 나눠서 답해:

## 강점
공고 요건 중 이력서에 실제로 적힌 경험이 충족하는 것만. 각 항목에 이력서의 해당 문구를 인용해 근거를 보여라
